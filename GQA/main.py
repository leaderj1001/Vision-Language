...
from preprocess import get_filename, load_question, batch_iterator
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1, args.epochs):
            for train_filename in train_filenames:
                train_question_json = load_question(train_filename)

                train_correct = 0
                for batch_image, batch_question, batch_question_length, batch_answer in tqdm(batch_iterator(train_question_json, args.batch_size)):
